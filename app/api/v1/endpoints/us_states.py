...
from app.crud import crud_us_state as crud_module

router = APIRouter()


@router.get("", response_model=List[schemas.UsStateSchema])
...
@router.get('/{pk}', response_model=schemas.UsStateSchema)

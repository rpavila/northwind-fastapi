...
from app.crud import crud_shipper as crud_module

router = APIRouter()


@router.get("", response_model=List[schemas.ShipperSchema])
...
@router.get('/{pk}', response_model=schemas.ShipperSchema)
